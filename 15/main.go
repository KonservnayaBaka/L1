...
var justString string //Глобальные переменные это плохо так как сильно вредит инкапсуляции, я бы переменную передавал в функцию. Но как понимаю суть задачи не в этом
